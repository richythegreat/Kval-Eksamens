<x-guest-layout>
    <div class="min-h-screen grid place-items-center px-4">
        <div class="w-full max-w-md rounded-2xl bg-white/5 ring-1 ring-gray-200 dark:ring-white/10 backdrop-blur-xl p-6">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Pāriestatīt paroli</h1>
            ...
            <form method="POST" action="{{ route('password.update') }}" class="mt-6 space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-white/80">jauna parole</label>
